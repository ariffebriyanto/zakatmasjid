...
<td>
           <a href="<?= BASEURL; ?>/Qurban/edit/<?= $d['id']?>" class="btn btn-primary btn-sm">Edit</a>
          <a href="<?= BASEURL; ?>/Qurban/hapus/<?= $d['id']?>" class="btn btn-danger btn-sm" onclick="return confirm('Data ini akan dihapus permanen');">Hapus</a>
        </td>
