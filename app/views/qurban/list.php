                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Peserta Dan Hewan Qurban</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
            ...
            <div class="data-table-area mg-b-15">
                        ...
                        <div class="col-lg-12">
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
								 <p align="left"><a href="<?= BASEURL; ?>/Qurban/tambah_banyak" button type="button" class="btn btn-primary">Tambah </a>
                                  </p>
                                    <div class="main-sparkline13-hd">
                                        <h1>Tabel <span class="table-project-n">Data</span>  Peserta Dan Hewan Qurban </h1>
                                    </div>
                                </div>
		      ...
		      <th>Jenis Hewan</th>
			     <th>Tahun</th>
                      ...
                      <tbody>
                         <?php $no=1; foreach ($data['qurban'] as $d): ?>
            <tr>
                <td><?= $no++; ?></td>
